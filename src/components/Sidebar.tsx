...
import { Dashboard, Home, Documents, Person, Form, Chart, PersonList, Persons, Status, Employer, News, Support, Tutorial, Light, Dark } from "@/assets";
...
const menuItems = [
  ...
  {
    icon: (color: string) => <Documents fill={color} />,
    text: "Tipos Documentos",
    active: false
  },
  {
    icon: (color: string) => <Person fill={color} />,
    text: "Pessoas envolvidas",
    active: false
  },
  {
    icon: (color: string) => <Form fill={color} />,
    text: "Formulários",
    active: false
  },
  {
    icon: (color: string) => <Chart fill={color} />,
    text: "Setor / Perfil",
    active: false
  },
  {
  ...
  {
    icon: (color: string) => <Persons fill={color} />,
    text: "Leads",
    active: false
  },
  {
    icon: (color: string) => <Status fill={color} />,
    text: "Status atendimento",
    active: false
  },
  {
    icon: (color: string) => <Employer fill={color} />,
    text: "Contratantes",
    active: false
  },
]
...
export function Sidebar({ setHideMenu, hideMenu }: SidebarProps) {
        ...
        <div className="flex flex-col flex-1  h-full w-full">
          <header className="flex justify-between items-center w-full">
            <div className="flex flex-1 shrink self-stretch my-auto w-full basis-0">
              ...
              <div className="flex flex-col items-center justify-end text-xl font-bold leading-none text-chart-1 whitespace-nowrap">
