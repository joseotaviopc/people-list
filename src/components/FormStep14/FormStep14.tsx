...
export default function FormStep14({ handleNextStep, handlePreviousStep }: FormStep14Props) {
    ...
    return (
        <>
            <div className="h-full pt-5 sm:pt-14">
                {/* TODO: Update title and description for Step 14 */}
                <h1 className="text-background font-bold text-sm sm:text-2xl mb-2.5 sm:mb-4">Possui algum tipo de litígio atualmente? (Step 14)</h1>
                ...
                <div className="flex  flex-col justify-center text-xs sm:text-sm gap-4 w-full">
                    {/* TODO: Update options for Step 14 */}
