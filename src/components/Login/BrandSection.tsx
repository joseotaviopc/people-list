...
export const BrandSection: React.FC = () => {
  return (
    <section className="flex gap-2.5 items-center self-stretch px-24 py-16 my-auto bg-sky-600 rounded-3xl min-w-60 w-[680px] max-md:px-5 max-md:max-w-full">
      <div className="flex flex-col flex-1 shrink justify-center self-stretch my-auto w-full basis-0 min-w-60 max-md:max-w-full">
        <div className="w-full max-md:max-w-full">
          <header className="flex flex-wrap w-full max-md:max-w-full">
            <div className="flex justify-center items-center px-1.5 pt-1 pb-1.5 my-auto w-11 rounded-sm bg-zinc-50">
              <img
            ...
            <div className="text-2xl font-semibold text-center text-rose-700 whitespace-nowrap w-[90px]">
              <div className="overflow-hidden self-stretch p-0.5 rounded-none bg-zinc-50 w-[90px]">
                FORMS
              </div>
            </div>
          </header>
          <div className="mt-5 w-full max-w-[508px] text-zinc-50 max-md:max-w-full">
