...
export const BrandSection: React.FC = () => {
  return (
    <section className="flex gap-2.5 items-center self-stretch px-14 py-16 my-auto bg-primary rounded-3xl min-w-60 max-w-3xl max-md:px-5 max-md:max-w-full">
      <div className="flex flex-col flex-1 shrink justify-center self-stretch my-auto w-full basis-0 min-w-60 max-md:max-w-full">
        <div className="w-full max-md:max-w-full">
          <header className="flex w-full max-md:max-w-full">
            <div className="flex justify-center items-center px-1.5 pt-1 pb-1.5 my-auto w-11 rounded-xs bg-background">
              <img
            ...
            <div className="text-[22px] font-semibold -ml-1.5 self-end h-full text-center text-chart-1 whitespace-nowrap w-[98px]">
              <div className="overflow-hidden p-0 rounded-xs rounded-bl-none bg-background w-[90px]">
                FORMS
              </div>
            </div>
          </header>
          <div className="mt-5 w-full max-w-[508px] text-background max-md:max-w-full">
            <h1 className="gap-2.5 self-stretch w-full text-4xl font-semibold max-md:max-w-full">
              Transforme informações em dados:
            </h1>
            <p className="gap-2.5 self-stretch mt-2.5 w-full font-light text-3xl max-md:max-w-full">
